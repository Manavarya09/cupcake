    ...
    <>
      <style>{`
        ...
        .vd-screen-wrap {
          ...
          box-shadow: 0 24px 80px rgba(0,0,0,0.08), 0 0 120px rgba(200,155,60,0.04);
          position: relative;
        }
        ...
        .vd-screen-wrap::before {
          ...
          border-radius: 15px;
          padding: 1px;
          background: linear-gradient(180deg, rgba(200,155,60,0.2) 0%, var(--border) 50%, rgba(200,155,60,0.15) 100%);
        ...
        .vd-highlight {
          ...
          box-shadow: inset 0 0 0 1px rgba(200,155,60,0.3), 0 0 20px rgba(200,155,60,0.06);
        }

        .vd-highlight-btn {
          background: rgba(200,155,60,0.2) !important;
          box-shadow: 0 0 16px rgba(200,155,60,0.2), inset 0 0 0 1px rgba(200,155,60,0.4);
        ...
        .vd-chip--active {
          ...
          box-shadow: 0 0 24px rgba(200,155,60,0.1);
        }
