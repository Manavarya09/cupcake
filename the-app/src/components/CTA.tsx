    ...
    <section id="early-access" className="cta-section" aria-label="Call to action">
      <div className="container">
        <div className="cta-content reveal" ref={ref}>
          ...
          <p>2.2 billion people are waiting for the web to catch up. cupcake doesn't replace their agency — it restores it. Join us in making every website accessible to every person, regardless of how they see.</p>
          <div className="cta-buttons">
            <EmailSignup variant="inline" />
            <a href="https://github.com/AryaaSk/cupcake" target="_blank" rel="noopener noreferrer" className="cta-github" aria-label="View cupcake on GitHub">
